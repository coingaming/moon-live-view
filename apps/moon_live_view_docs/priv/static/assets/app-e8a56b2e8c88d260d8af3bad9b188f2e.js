  ...
  var LiveSocket = class {
    ...
    bindNav() {
      ...
      window.addEventListener("popstate", (event) => {
        ...
        let { type, backType, id, scroll: scroll2, position } = event.state || {};
...
${parts.slice(9, 13).join(" ")} ${parts.slice(13).join(" ")}`;
  ...
  var Accordion = {
    ...
    cloneAndCalculateHeight(element) {
      ...
      clone2.style.top = "-9999px";
      clone2.style.left = "-9999px";
      clone2.style.maxHeight = "4000px";
      clone2.style.visibility = "hidden";
      clone2.style.display = "block";
      clone2.style.width = element.parentElement.offsetWidth + "px";
      ...
      if (parentPaddingVar) {
        clone2.style.setProperty(
          "--mds-accordion-padding",
          parentPaddingVar.trim()
        );
      }
      const tw = document.createTreeWalker(clone2, NodeFilter.SHOW_ALL);
      let i = 0;
      ...
      const height = clone2.offsetHeight;
      clone2.remove();
      return height;
    }
  };
  ...
  // js/hooks/index.js
  var hooks_default3 = __spreadValues({
